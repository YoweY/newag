 ...
 * 
 */
package aegis.aegisxunfei.result.xml;
...
import aegis.aegisxunfei.result.FinalResult;
import aegis.aegisxunfei.result.ReadSentenceResult;
import aegis.aegisxunfei.result.ReadSyllableResult;
import aegis.aegisxunfei.result.ReadWordResult;
import aegis.aegisxunfei.result.Result;
import aegis.aegisxunfei.result.entity.Phone;
import aegis.aegisxunfei.result.entity.Sentence;
import aegis.aegisxunfei.result.entity.Syll;
import aegis.aegisxunfei.result.entity.Word;
